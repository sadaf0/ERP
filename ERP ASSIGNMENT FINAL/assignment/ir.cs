...
namespace assignment
{
    public partial class ir : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                x.oleDbConnection1.Open();
                OleDbCommand cmd = new OleDbCommand("insert into ir (soid,cid,cname,cadd,city,cp,dcdate,amountrec) values(@soid,@cid,@cname,@cadd,@city,@cp,@dcdate,@amountrec)", x.oleDbConnection1);
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Invoice Receipt Successfully Created");
                textBox7.Text += "SO-ID: " + comboBox1.Text + Environment.NewLine + "C-Id: " + textBox1.Text + Environment.NewLine + "C-Name: " + textBox2.Text + Environment.NewLine + "C-Address: " + textBox3.Text + Environment.NewLine + "City: " + textBox6.Text + Environment.NewLine + "CP: " + textBox4.Text + Environment.NewLine + "Delievery Chalan Date: " + dateTimePicker1.Text + Environment.NewLine + "Amount Receive: " + textBox5.Text;
            }
            catch (Exception ee)
            {
